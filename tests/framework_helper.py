...
class hsl20_4:
    ...
    class BaseModule:
        def __init__(self, a, b):
            self.module_id = 0
            self.debug_output_value = {}  # type: {int, any}
            self.debug_set_remanent = {}  # type: {int, any}
            self.debug_input_value = {}  # type: {int: any}
    ...
    class Framework:
        ...
        def get_instance_by_id(self, id):
            # type: (int) -> Leistungsmesser_11083_11083
            return Leistungsmesser_11083_11083(0)
